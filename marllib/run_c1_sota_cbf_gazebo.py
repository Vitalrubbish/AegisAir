...
PROTOCOL_IDS = {
    ...
    "aegisair-trigger-comparison-development-v1",
    "aegisair-trigger-comparison-sealed-v1",
    ...
    if method.startswith("AEGIS_HOCBF_V4"):
        return {
            ...
            **feedforward,
            ...
            "hocbf_recovery_distance_threshold_m": config.get("recovery_distance_threshold_m"),
            "hocbf_recovery_ttc_threshold_s": config.get("recovery_ttc_threshold_s"),
